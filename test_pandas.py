...
# df_userInfo_summary = pd.concat([ele[['text', 'Id member', 'phone member','addr member']] for ele in [df_175]])
# df_userInfo_summary.fillna('', inplace = True)
# df_userInfo_summary = df_userInfo_summary[df_userInfo_summary['Id member'] != '']

# # print(df_text_summary['Id member'])
# ls_userInfo = FilterListText(list(df_userInfo_summary['text']))
# ls_userId = FilterListText(list(df_userInfo_summary['Id member']))
# ls_userPhone = FilterListText(list(df_userInfo_summary['phone member']))
# ls_userAddr= FilterListText(list(df_userInfo_summary['addr member']))
